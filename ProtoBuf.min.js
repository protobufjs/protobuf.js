...
*/
(function(p){function q(n){if(!n||!n.zigZagEncode32)throw Error("ProtoBuf.js requires ByteBuffer.js >=1.1.0: Get it at https://github.com/dcodeIO/ByteBuffer.js");var f={VERSION:"1.1.2",WIRE_TYPES:{}};f.WIRE_TYPES.VARINT=0;f.WIRE_TYPES.BITS64=1;f.WIRE_TYPES.LDELIM=2;f.WIRE_TYPES.STARTGROUP=3;f.WIRE_TYPES.ENDGROUP=4;f.WIRE_TYPES.BITS32=5;f.TYPES={int32:{name:"int32",wireType:f.WIRE_TYPES.VARINT},uint32:{name:"uint32",wireType:f.WIRE_TYPES.VARINT},sint32:{name:"sint32",wireType:f.WIRE_TYPES.VARINT},
...
a||new n;var c=a.littleEndian,d=b.encode(this,a.LE()).flip();a.littleEndian=c;return d};g.prototype.toArrayBuffer=function(){return this.encode().toArrayBuffer()};g.prototype.toBuffer=function(){return this.encode().toBuffer()};g.decode=function(a){a=a?a instanceof n?a:n.wrap(a):new n;var c=a.littleEndian,d=b.decode(a.LE());a.littleEndian=c;return d};g.prototype.toString=function(){return b.toString()};Object.defineProperty&&Object.defineProperty(g,"$options",{value:b.buildOpt(),enumerable:!1,configurable:!1,
writable:!1});return g}(b,this),k=this.getChildren(),l=0;l<k.length;l++)if(k[l]instanceof e)d[k[l].name]=k[l].build();else if(k[l]instanceof a)d[k[l].name]=k[l].build();else if(!(k[l]instanceof a.Field))throw Error("Illegal reflect child of "+this.toString(!0)+": "+k[l].toString(!0));return this.clazz=d};a.prototype.encode=function(c,b){for(var d=this.getChildren(a.Field),e=0;e<d.length;e++)d[e].encode(c.get(d[e].name),b);return b};a.prototype.decode=function(a,d){d=d||-1;for(var e=a.offset,f=new this.clazz;a.offset<
e+d||-1==d&&0<a.remaining();){var h=a.readVarint32(),m=h&7,h=h>>3,n=this.getChild(h);if(n)n.repeated&&!n.options.packed?f.add(n.name,n.decode(m,a)):f.set(n.name,n.decode(m,a));else switch(m){case c.WIRE_TYPES.VARINT:a.readVarint32();break;case c.WIRE_TYPES.BITS32:a.offset+=4;break;case c.WIRE_TYPES.BITS64:a.offset+=8;break;case c.WIRE_TYPES.LDELIM:m=a.readVarint32();a.offset+=m;break;default:throw Error("Illegal wire type of unknown field "+h+" in "+this.toString(!0)+"#decode: "+m);}}e=this.getChildren(b.Field);
for(m=0;m<e.length;m++)if(e[m].required&&null===f[e[m].name])throw e=Error("Missing field "+e[m].toString(!0)+" in "+this.toString(!0)+"#decode"),e.msg=f,e;return f};b.Message=a;var d=function(a,c,b,d,e,h){f.call(this,a,d);this.required="required"==c;this.repeated="repeated"==c;this.type=b;this.resolvedType=null;this.id=e;this.options=h||{}};d.prototype=Object.create(f.prototype);d.prototype.verifyValue=function(a,b){b=b||!1;if(null===a){if(this.required)throw Error("Illegal value for "+this.toString(!0)+
": "+a+" (required)");return null}var d;if(this.repeated&&!b){a instanceof Array||(a=[a]);var f=[];for(d=0;d<a.length;d++)f.push(this.verifyValue(a[d],!0));return f}if(!this.repeated&&a instanceof Array)throw Error("Illegal value for "+this.toString(!0)+": "+a+" (no array expected)");if(this.type==c.TYPES.int32||this.type==c.TYPES.sint32||this.type==c.TYPES.sfixed32)return parseInt(a,10)|0;if(this.type==c.TYPES.uint32||this.type==c.TYPES.fixed32)return parseInt(a,10)>>>0;if(c.Long){if(this.type==
...
JSON.stringify(e));else throw Error("Not a valid namespace definition: "+JSON.stringify(a));this.ptr=this.ptr.parent}this.resolved=!1;this.result=null;return this}};h.isValidImport=function(a){return!/google\/protobuf\//.test(a)};h.prototype.files=[];h.prototype["import"]=function(a,b){if("string"===typeof b){c.Util.IS_NODE&&(b=require("path").resolve(b));if(this.files[b])return this.reset(),this;this.files[b]=!0}a["package"]&&this.define(a["package"],a.options);a.messages&&this.create(a.messages);
this.reset();a["package"]&&this.define(a["package"],a.options);a.enums&&this.create(a.enums);this.reset();if(a.imports&&0<a.imports.length){if(!b)throw Error("Cannot determine import root: File name is unknown");for(var e=b.replace(/[\/\\][^\/\\]*$/,""),f=0;f<a.imports.length;f++){var k=e+"/"+a.imports[f];if(/\.json$/i.test(k)){var l=c.Util.fetch(k);if(null===l)throw Error("Failed to import '"+k+"' in '"+b+"': File not found");this["import"](JSON.parse(l),k)}else if(h.isValidImport(k)){l=c.Util.fetch(k);
if(null===l)throw Error("Failed to import '"+k+"' in '"+b+"': File not found");l=new c.DotProto.Parser(l+"");this["import"](l.parse(),k)}}}return this};h.prototype.resolveAll=function(){if(!(null==this.ptr||"object"==typeof this.ptr.type)){if(this.ptr instanceof f.Namespace)for(var a=this.ptr.getChildren(),d=0;d<a.length;d++)this.ptr=a[d],this.resolveAll();else if(this.ptr instanceof f.Message.Field)if(b.TYPE.test(this.ptr.type))this.ptr.type=c.TYPES[this.ptr.type];else{if(!b.TYPEREF.test(this.ptr.type))throw Error("Illegal type reference in "+
this.ptr.toString(!0)+": "+this.ptr.type);a=this.ptr.parent.resolve(this.ptr.type);if(!a)throw Error("Unresolvable type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);this.ptr.resolvedType=a;if(a instanceof f.Enum)this.ptr.type=c.TYPES["enum"];else if(a instanceof f.Message)this.ptr.type=c.TYPES.message;else throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);}else if(!(this.ptr instanceof c.Reflect.Enum.Value))throw Error("Illegal object type in namespace: "+
typeof this.ptr+":"+this.ptr);this.reset()}};h.prototype.build=function(a){this.reset();this.resolved||(this.resolveAll(),this.resolved=!0,this.result=null);null==this.result&&(this.result=this.ns.build());if(a){a=a.split(".");for(var b=this.result,c=0;c<a.length;c++)if(b[a[c]])b=b[a[c]];else{b=null;break}return b}return this.result};h.prototype.lookup=function(a){return a?this.ns.resolve(a):this.ns};h.prototype.toString=function(){return"Builder"};h.Message=function(){};return h}(f,f.Lang,f.Reflect);
f.protoFromString=function(c,b,m){"string"==typeof b&&(m=b,b=null);c=(new f.DotProto.Parser(c+"")).parse();b="object"==typeof b?b:new f.Builder;null!==c["package"]&&b.define(c["package"],c.options);b.create(c.messages);b.reset();null!==c["package"]&&b.define(c["package"],c.options);b.create(c.enums);b.reset();if(m&&0<c.imports.length)b["import"]({imports:c.imports},m);b.resolveAll();b.build();return b};f.protoFromFile=function(c,b,m){if(b&&"object"==typeof b)m=b,b=null;else if(!b||"function"!=typeof b)b=
null;if(b)f.Util.fetch(c,function(a){b(f.protoFromString(a,m,c))});else{var h=f.Util.fetch(c);return null!==h?f.protoFromString(h,m,c):null}};f.newBuilder=function(c,b){var m=new f.Builder;"undefined"!=typeof c&&m.define(c,b);return m};return f}"undefined"!=typeof module&&module.exports?module.exports=q(require("bytebuffer")):"undefined"!=typeof define&&define.amd?define("ProtoBuf",["ByteBuffer"],q):(p.dcodeIO||(p.dcodeIO={}),p.dcodeIO.ProtoBuf=q(p.dcodeIO.ByteBuffer))})(this);
