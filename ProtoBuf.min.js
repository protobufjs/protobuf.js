...
*/
(function(p){function q(n){if(!n||!n.zigZagEncode32)throw Error("ProtoBuf.js requires ByteBuffer.js >=1.1.0: Get it at https://github.com/dcodeIO/ByteBuffer.js");var f={VERSION:"1.1.3",WIRE_TYPES:{}};f.WIRE_TYPES.VARINT=0;f.WIRE_TYPES.BITS64=1;f.WIRE_TYPES.LDELIM=2;f.WIRE_TYPES.STARTGROUP=3;f.WIRE_TYPES.ENDGROUP=4;f.WIRE_TYPES.BITS32=5;f.TYPES={int32:{name:"int32",wireType:f.WIRE_TYPES.VARINT},uint32:{name:"uint32",wireType:f.WIRE_TYPES.VARINT},sint32:{name:"sint32",wireType:f.WIRE_TYPES.VARINT},
...
writable:!1});return g}(b,this),k=this.getChildren(),l=0;l<k.length;l++)if(k[l]instanceof e)d[k[l].name]=k[l].build();else if(k[l]instanceof a)d[k[l].name]=k[l].build();else if(!(k[l]instanceof a.Field))throw Error("Illegal reflect child of "+this.toString(!0)+": "+k[l].toString(!0));return this.clazz=d};a.prototype.encode=function(c,b){for(var d=this.getChildren(a.Field),e=0;e<d.length;e++)d[e].encode(c.get(d[e].name),b);return b};a.prototype.decode=function(a,d){d="number"===typeof d?d:-1;for(var e=
a.offset,f=new this.clazz;a.offset<e+d||-1==d&&0<a.remaining();){var h=a.readVarint32(),m=h&7,h=h>>3,n=this.getChild(h);if(n)n.repeated&&!n.options.packed?f.add(n.name,n.decode(m,a)):f.set(n.name,n.decode(m,a));else switch(m){case c.WIRE_TYPES.VARINT:a.readVarint32();break;case c.WIRE_TYPES.BITS32:a.offset+=4;break;case c.WIRE_TYPES.BITS64:a.offset+=8;break;case c.WIRE_TYPES.LDELIM:m=a.readVarint32();a.offset+=m;break;default:throw Error("Illegal wire type of unknown field "+h+" in "+this.toString(!0)+
"#decode: "+m);}}e=this.getChildren(b.Field);for(m=0;m<e.length;m++)if(e[m].required&&null===f[e[m].name])throw e=Error("Missing field "+e[m].toString(!0)+" in "+this.toString(!0)+"#decode"),e.msg=f,e;return f};b.Message=a;var d=function(a,c,b,d,e,h){f.call(this,a,d);this.required="required"==c;this.repeated="repeated"==c;this.type=b;this.resolvedType=null;this.id=e;this.options=h||{}};d.prototype=Object.create(f.prototype);d.prototype.verifyValue=function(a,b){b=b||!1;if(null===a){if(this.required)throw Error("Illegal value for "+
