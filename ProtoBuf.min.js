...
*/
(function(p){function q(n){if(!n||!n.zigZagEncode32)throw Error("ProtoBuf.js requires ByteBuffer.js >=1.1.0: Get it at https://github.com/dcodeIO/ByteBuffer.js");var f={VERSION:"1.0.4",WIRE_TYPES:{}};f.WIRE_TYPES.VARINT=0;f.WIRE_TYPES.BITS64=1;f.WIRE_TYPES.LDELIM=2;f.WIRE_TYPES.STARTGROUP=3;f.WIRE_TYPES.ENDGROUP=4;f.WIRE_TYPES.BITS32=5;f.TYPES={int32:{name:"int32",wireType:f.WIRE_TYPES.VARINT},uint32:{name:"uint32",wireType:f.WIRE_TYPES.VARINT},sint32:{name:"sint32",wireType:f.WIRE_TYPES.VARINT},
...
this.result&&(this.result=this.ns.build());if(a){a=a.split(".");for(var b=this.result,c=0;c<a.length;c++)if(b[a[c]])b=b[a[c]];else{b=null;break}return b}return this.result};h.prototype.lookup=function(a){return a?this.ns.resolve(a):this.ns};h.prototype.toString=function(){return"Builder"};return h}(f,f.Lang,f.Reflect);f.protoFromString=function(c,b,m){"string"==typeof b&&(m=b,b=null);c=(new f.DotProto.Parser(c+"")).parse();b="object"==typeof b?b:new f.Builder;null!==c["package"]&&b.define(c["package"],
c.options);b.create(c.messages);b.reset();null!==c["package"]&&b.define(c["package"],c.options);b.create(c.enums);b.reset();if(m&&0<c.imports.length)b["import"]({imports:c.imports},m);b.resolveAll();b.build();return b};f.protoFromFile=function(c,b,m){if(b&&"object"==typeof b)m=b,b=null;else if(!b||"function"!=typeof b)b=null;if(b)f.Util.fetch(c,function(a){b(f.protoFromString(a,m,c))});else{var h=f.Util.fetch(c);return null!==h?f.protoFromString(h,m,c):null}};f.newBuilder=function(c,b){var m=new f.Builder;
"undefined"!=typeof c&&m.define(c,b);return m};return f}"undefined"!=typeof module&&module.exports?module.exports=q(require("bytebuffer")):"undefined"!=typeof define&&define.amd?define("ProtoBuf",["ByteBuffer"],q):(p.dcodeIO||(p.dcodeIO={}),p.dcodeIO.ProtoBuf=q(p.dcodeIO.ByteBuffer))})(this);
