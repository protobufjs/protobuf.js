...
b="Message.Field "+b:this instanceof e?b="Enum "+b:this instanceof e.Value?b="Enum.Value "+b:this instanceof k?b="Service "+b:this instanceof k.Method?b=this instanceof k.RPCMethod?"Service.RPCMethod "+b:"Service.Method "+b:this instanceof f&&(b="Namespace "+b));return b};h.prototype.build=function(){throw Error(this.toString(!0)+" cannot be built directly");};b.T=h;var f=function(a,c,b){h.call(this,a,c);this.children=[];this.options=b||{}};f.prototype=Object.create(h.prototype);f.prototype.getChildren=
...
a.Field))throw Error("Illegal reflect child of "+this.toString(!0)+": "+m[q].toString(!0));return this.clazz=d};a.prototype.encode=function(c,b){for(var d=this.getChildren(a.Field),e=0;e<d.length;e++)d[e].encode(c.get(d[e].name),b);return b};a.prototype.decode=function(a,d){d="number"===typeof d?d:-1;for(var e=a.offset,k=new this.clazz;a.offset<e+d||-1==d&&0<a.remaining();){var h=a.readVarint32(),f=h&7,h=h>>3,l=this.getChild(h);if(l)l.repeated&&!l.options.packed?k.add(l.name,l.decode(f,a)):k.set(l.name,
l.decode(f,a));else switch(f){case c.WIRE_TYPES.VARINT:a.readVarint32();break;case c.WIRE_TYPES.BITS32:a.offset+=4;break;case c.WIRE_TYPES.BITS64:a.offset+=8;break;case c.WIRE_TYPES.LDELIM:f=a.readVarint32();a.offset+=f;break;default:throw Error("Illegal wire type of unknown field "+h+" in "+this.toString(!0)+"#decode: "+f);}}e=this.getChildren(b.Field);for(f=0;f<e.length;f++)if(e[f].required&&null===k[e[f].name])throw e=Error("Missing field "+e[f].toString(!0)+" in "+this.toString(!0)+"#decode"),
e.msg=k,e;return k};b.Message=a;var d=function(a,c,b,d,e,f){h.call(this,a,d);this.required="required"==c;this.repeated="repeated"==c;this.type=b;this.resolvedType=null;this.id=e;this.options=f||{}};d.prototype=Object.create(h.prototype);d.prototype.verifyValue=function(a,b){b=b||!1;if(null===a){if(this.required)throw Error("Illegal value for "+this.toString(!0)+": "+a+" (required)");return null}var d;if(this.repeated&&!b){c.Util.isArray(a)||(a=[a]);var f=[];for(d=0;d<a.length;d++)f.push(this.verifyValue(a[d],
...
g=new c.DotProto.Parser(g+"");this["import"](g.parse(),l)}}}return this};f.isValidService=function(a){return"string"!=typeof a.name||!b.NAME.test(a.name)||"object"!=typeof a.rpc?!1:!0};f.prototype.resolveAll=function(){var a;if(!(null==this.ptr||"object"==typeof this.ptr.type)){if(this.ptr instanceof h.Namespace){a=this.ptr.getChildren();for(var d=0;d<a.length;d++)this.ptr=a[d],this.resolveAll()}else if(this.ptr instanceof h.Message.Field)if(b.TYPE.test(this.ptr.type))this.ptr.type=c.TYPES[this.ptr.type];
...
c.options),b.create(c.enums),b.reset());0<c.services.length&&(null!==c["package"]&&b.define(c["package"],c.options),b.create(c.services),b.reset());if(l&&0<c.imports.length)b["import"]({imports:c.imports},l);b.resolveAll();b.build();return b};h.protoFromFile=function(c,b,l){if(b&&"object"==typeof b)l=b,b=null;else if(!b||"function"!=typeof b)b=null;if(b)h.Util.fetch(c,function(a){b(h.protoFromString(a,l,c))});else{var f=h.Util.fetch(c);return null!==f?h.protoFromString(f,l,c):null}};h.newBuilder=
function(c,b){var l=new h.Builder;"undefined"!=typeof c&&l.define(c,b);return l};return h}"undefined"!=typeof module&&module.exports?module.exports=s(require("bytebuffer")):"undefined"!=typeof define&&define.amd?define("ProtoBuf",["ByteBuffer"],s):(r.dcodeIO||(r.dcodeIO={}),r.dcodeIO.ProtoBuf=s(r.dcodeIO.ByteBuffer))})(this);
