...
parseInt(a);else if(d.NAME.test(a))f=a;else throw Error("Illegal option value in message "+b.name+", option "+c+": "+a);a=this.tn.next();if(a!=d.END)throw Error("Illegal end of option in message "+b.name+", option "+c+": "+a+" ('"+d.END+"' expected)");b.options[c]=f};b.prototype._parseMessage=function(b,a){var c={};a=this.tn.next();if(!d.NAME.test(a))throw Error("Illegal message name"+(b?" in message "+b.name:"")+": "+a);c.name=a;a=this.tn.next();if(a!=d.OPEN)throw Error("Illegal OPEN after message "+
