 ...
 */
declare class Field extends ReflectionObject {
   /**
    * Reflected message field.
    * @extends ReflectionObject
    * @constructor
 ...
 * @param {Object.<string,*>} [options] Field options
 */
declare class MapField extends Field {
   /**
    * Reflected message map field.
    * @extends Field
    * @constructor
 ...
 */
declare class Namespace extends ReflectionObject {
   /**
    * Base class of all reflection objects containing nested objects.
    * @extends ReflectionObject
    * @constructor
 ...
 * @private
 */
declare function addFieldsToParent(oneof: OneOf): undefined;
 ...
 */
declare function parse(source: string, root?: Root, visible?: boolean): Object;
 ...
 * @param {Object.<string,*>} [options] Namespace options
 */
declare class Root extends Namespace {
   /**
    * Root namespace.
    * @extends Namespace
    * @constructor
 ...
 * @private
 */
declare function handleExtension(field: Field): boolean;
 ...
 * @throws {TypeError} If arguments are invalid
 */
declare class Service extends Namespace {
   /**
    * Reflected service.
    * @extends Namespace
    * @constructor
 ...
 */
declare function tokenize(source: string): Object;
 ...
 */
declare class Type extends Namespace {
   /**
    * Reflected message type.
    * @extends Namespace
    * @constructor
 ...
 * @private
 */
declare function clearCache(type: Type): Type;
 ...
 * @private
 */
declare function expand(writer: Writer, writeLength: number): undefined;
