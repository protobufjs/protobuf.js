...
tape.test("invalid edition", function(test) {
    ...
    }, Error, /Error: illegal token \(line 1, column 11\)/, "unknown past edition should be rejected");

    test.throws(function() {
        protobuf.parse(`edition = "2030"; message A {}`);
    }, Error, /Error: illegal token \(line 1, column 11\)/, "unknown future edition should be rejected");
...
message A {
    ...
    }, Error,  /Error: illegal token \(line 3, column 5\)/, "required should be banned");
...
message A {
    ...
    }, Error, /Error: illegal token \(line 3, column 5\)/, "optional should be banned");
...
message A {
    ...
    }, Error, /Error: illegal token \(line 3, column 5\)/);
...
message Foo {
    ...
    }, /Error: illegal token \(line 1, column 19\)/, "export should be banned before edition 2024");
    test.throws(function() {
        protobuf.parse(`edition = "2024"; export service Foo {}`)
    }, /Error: illegal token \(line 1, column 26\)/, "export should be banned on services");
    test.throws(function() {
...
service Foo {
    ...
    }, /Error: illegal token \(line 4, column 12\)/, "export should be banned on methods");
    test.throws(function() {
        protobuf.parse(`edition = "2024"; export option foo = 1;`)
    }, /Error: illegal token \(line 1, column 26\)/, "export should be banned on options");

    test.throws(function() {
        protobuf.parse(`edition = "2023"; local message Foo {}`)
    }, /Error: illegal token \(line 1, column 19\)/, "local should be banned before edition 2024");
    test.throws(function() {
        protobuf.parse(`edition = "2024"; local service Foo {}`)
    }, /Error: illegal token \(line 1, column 25\)/, "local should be banned on services");
    test.throws(function() {
        protobuf.parse(`edition = "2024";
message Empty {}
service Foo {
    ...
    }, /Error: illegal token \(line 4, column 11\)/, "local should be banned on methods");
    test.throws(function() {
        protobuf.parse(`edition = "2024"; local option foo = 1;`)
    }, /Error: illegal token \(line 1, column 25\)/, "local should be banned on options");
...
import "bar.proto";
import option "foo2.proto";`).imports, ["bar.proto"], "multiple import options should not fetch");

    test.throws(function() {
        protobuf.parse(`edition = "2023"; import option "foo.proto";`);
    }, /Error: illegal token \(line 1, column 26\)/, "import option should be banned before edition 2024");
