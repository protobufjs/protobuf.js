...
return m};d.fetch=function(f,m){m&&"function"!=typeof m&&(m=null);if(d.IS_NODE)if(m)require("fs").readFile(f,function(d,b){d?m(null):m(""+b)});else try{return require("fs").readFileSync(f)}catch(b){return null}else{var e=d.XHR();e.open("GET",f,m?!0:!1);e.setRequestHeader("Accept","text/plain");"function"===typeof e.overrideMimeType&&e.overrideMimeType("text/plain");if(m)e.onreadystatechange=function(){4==e.readyState&&(200==e.status||0==e.status&&"string"===typeof e.responseText?m(e.responseText):
...
NEGID:/^\-?(?:[1-9][0-9]*|0|0x[0-9a-fA-F]+|0[0-7]+)$/,WHITESPACE:/\s/,STRING:/['"]([^'"\\]*(\\.[^"\\]*)*)['"]/g,BOOL:/^(?:true|false)$/i};f.Reflect=function(d){function f(a,h){var b=h.readVarint32(),c=b&7,b=b>>3;switch(c){case d.WIRE_TYPES.VARINT:do b=h.readUint8();while(128===(b&128));break;case d.WIRE_TYPES.BITS64:h.offset+=8;break;case d.WIRE_TYPES.LDELIM:b=h.readVarint32();h.offset+=b;break;case d.WIRE_TYPES.STARTGROUP:f(b,h);break;case d.WIRE_TYPES.ENDGROUP:if(b===a)return!1;throw Error("Illegal GROUPEND after unknown group: "+
b+" ("+a+" expected)");case d.WIRE_TYPES.BITS32:h.offset+=4;break;default:throw Error("Illegal wire type in unknown group "+a+": "+c);}return!0}function p(a,h){if(a&&"number"===typeof a.low&&"number"===typeof a.high&&"boolean"===typeof a.unsigned&&a.low===a.low&&a.high===a.high)return new d.Long(a.low,a.high,"undefined"===typeof h?a.unsigned:h);if("string"===typeof a)return d.Long.fromString(a,h||!1,10);if("number"===typeof a)return d.Long.fromNumber(a,h||!1);throw Error("not convertible to Long");
}var m={},b=function(a,h){this.parent=a;this.name=h};b.prototype.fqn=function(){var a=this.name,h=this;do{h=h.parent;if(null==h)break;a=h.name+"."+a}while(1);return a};b.prototype.toString=function(a){return(a?this.className+" ":"")+this.fqn()};b.prototype.build=function(){throw Error(this.toString(!0)+" cannot be built directly");};m.T=b;var e=function(a,h,d){b.call(this,a,h);this.className="Namespace";this.children=[];this.options=d||{}};e.prototype=Object.create(b.prototype);e.prototype.getChildren=
function(a){a=a||null;if(null==a)return this.children.slice();for(var h=[],b=0,d=this.children.length;b<d;++b)this.children[b]instanceof a&&(a===c.Field&&this.children[b]instanceof c.ExtendedField||h.push(this.children[b]));return h};e.prototype.addChild=function(a){var h;if(h=this.getChild(a.name))if(h instanceof c.Field&&h.name!==h.originalName&&!this.hasChild(h.originalName))h.name=h.originalName;else if(a instanceof c.Field&&a.name!==a.originalName&&!this.hasChild(a.originalName))a.name=a.originalName;
else throw Error("Duplicate name in namespace "+this.toString(!0)+": "+a.name);this.children.push(a)};e.prototype.hasChild=function(a){return-1<this._indexOf(a)};e.prototype.getChild=function(a){a=this._indexOf(a);return-1<a?this.children[a]:null};e.prototype._indexOf=function(a){for(var h="number"===typeof a?"id":"name",b=0;b<this.children.length;b++)if("undefined"!==typeof this.children[b][h]&&this.children[b][h]==a)return b;return-1};e.prototype.resolve=function(a,h){var b=a.split("."),d=this,
c=0;if(""==b[c]){for(;null!=d.parent;)d=d.parent;c++}do{do{d=d.getChild(b[c]);if(!(d&&d instanceof m.T)||h&&d instanceof m.Message.Field){d=null;break}c++}while(c<b.length);if(null!=d)break;if(null!==this.parent)return this.parent.resolve(a,h)}while(null!=d);return d};e.prototype.build=function(){for(var a={},h=this.getChildren(),b,d=0,c=h.length;d<c;++d)b=h[d],b instanceof e&&(a[b.name]=b.build());Object.defineProperty&&Object.defineProperty(a,"$options",{value:this.buildOpt()});return a};e.prototype.buildOpt=
function(){for(var a={},h=Object.keys(this.options),b=0;b<h.length;b++)a[h[b]]=this.options[h[b]];return a};e.prototype.getOption=function(a){return"undefined"===typeof a?this.options:"undefined"!==typeof this.options[a]?this.options[a]:null};m.Namespace=e;var c=function(a,h,b,c){e.call(this,a,h,b);this.className="Message";this.extensions=[d.ID_MIN,d.ID_MAX];this.clazz=null;this.isGroup=!!c};c.prototype=Object.create(e.prototype);c.prototype.build=function(a){if(this.clazz&&!a)return this.clazz;a=
function(a,b){function d(a,b){var h={},c;for(c in a)a.hasOwnProperty(c)&&(null===a[c]||"object"!==typeof a[c]?h[c]=a[c]:a[c]instanceof g?b&&(h[c]=a.toBuffer()):h[c]=d(a[c],b));return h}var h=b.getChildren(a.Reflect.Message.Field),c=function(b){a.Builder.Message.call(this);var d,c;for(d=0;d<h.length;d++)c=h[d],this[c.name]=c.repeated?[]:null;for(d=0;d<h.length;d++)if(c=h[d],"undefined"!=typeof c.options["default"])try{this.$set(c.name,c.options["default"])}catch(e){throw Error("[INTERNAL] "+e);}if(1!=
arguments.length||"object"!=typeof b||"function"==typeof b.encode||a.Util.isArray(b)||b instanceof g||b instanceof ArrayBuffer||a.Long&&b instanceof a.Long)for(d=0;d<arguments.length;d++)d<h.length&&this.$set(h[d].name,arguments[d]);else for(c=Object.keys(b),d=0;d<c.length;d++)this.$set(c[d],b[c[d]])};c.prototype=Object.create(a.Builder.Message.prototype);c.prototype.add=function(d,h,c){var e=b.getChild(d);if(!e)throw Error(this+"#"+d+" is undefined");if(!(e instanceof a.Reflect.Message.Field))throw Error(this+
"#"+d+" is not a field: "+e.toString(!0));if(!e.repeated)throw Error(this+"#"+d+" is not a repeated field");null===this[e.name]&&(this[e.name]=[]);this[e.name].push(c?h:e.verifyValue(h,!0))};c.prototype.$add=c.prototype.add;c.prototype.set=function(d,h,c){var e=b.getChild(d);if(!e)throw Error(this+"#"+d+" is not a field: undefined");if(!(e instanceof a.Reflect.Message.Field))throw Error(this+"#"+d+" is not a field: "+e.toString(!0));this[e.name]=c?h:e.verifyValue(h)};c.prototype.$set=c.prototype.set;
c.prototype.get=function(d){var h=b.getChild(d);if(!(h&&h instanceof a.Reflect.Message.Field))throw Error(this+"#"+d+" is not a field: undefined");if(!(h instanceof a.Reflect.Message.Field))throw Error(this+"#"+d+" is not a field: "+h.toString(!0));return this[h.name]};c.prototype.$get=c.prototype.get;for(var e=0;e<h.length;e++)(function(a){var d=a.originalName.replace(/(_[a-zA-Z])/g,function(a){return a.toUpperCase().replace("_","")}),d=d.substring(0,1).toUpperCase()+d.substring(1),h=a.originalName.replace(/([A-Z])/g,
function(a){return"_"+a});b.hasChild("set"+d)||(c.prototype["set"+d]=function(b){this.$set(a.name,b)});b.hasChild("set_"+h)||(c.prototype["set_"+h]=function(b){this.$set(a.name,b)});b.hasChild("get"+d)||(c.prototype["get"+d]=function(){return this.$get(a.name)});b.hasChild("get_"+h)||(c.prototype["get_"+h]=function(){return this.$get(a.name)})})(h[e]);c.prototype.encode=function(a){var d=!1;a||(a=new g,d=!0);var h=a.littleEndian;try{return b.encode(this,a.LE()),(d?a.flip():a).LE(h)}catch(c){throw a.LE(h),
c;}};c.prototype.calculate=function(){return b.calculate(this)};c.prototype.encodeDelimited=function(a){var d=!1;a||(a=new g,d=!0);var h=(new g).LE();b.encode(this,h).flip();a.writeVarint32(h.remaining());a.append(h);return d?a.flip():a};c.prototype.encodeAB=function(){try{return this.encode().toArrayBuffer()}catch(a){throw a.encoded&&(a.encoded=a.encoded.toArrayBuffer()),a;}};c.prototype.toArrayBuffer=c.prototype.encodeAB;c.prototype.encodeNB=function(){try{return this.encode().toBuffer()}catch(a){throw a.encoded&&
...
0:!!a):b.writeVarint32(a?1:0);break;case d.TYPES["enum"]:b.writeVarint32(a);break;case d.TYPES["float"]:b.writeFloat32(a);break;case d.TYPES["double"]:b.writeFloat64(a);break;case d.TYPES.string:b.writeVString(a);break;case d.TYPES.bytes:if(0>a.remaining())throw Error("Illegal value for "+this.toString(!0)+": "+a.remaining()+" bytes remaining");var c=a.offset;b.writeVarint32(a.remaining());b.append(a);a.offset=c;break;case d.TYPES.message:c=(new g).LE();this.resolvedType.encode(a,c);b.writeVarint32(c.offset);
b.append(c.flip());break;case d.TYPES.group:this.resolvedType.encode(a,b);b.writeVarint32(this.id<<3|d.WIRE_TYPES.ENDGROUP);break;default:throw Error("[INTERNAL] Illegal value to encode in "+this.toString(!0)+": "+a+" (unknown type)");}return b};k.prototype.calculate=function(a){a=this.verifyValue(a);if(null===this.type||"object"!==typeof this.type)throw Error("[INTERNAL] Unresolved type in "+this.toString(!0)+": "+this.type);if(null===a||this.repeated&&0==a.length)return 0;var b=0;try{if(this.repeated){var c,
e;if(this.options.packed&&0<=d.PACKABLE_WIRE_TYPES.indexOf(this.type.wireType)){b+=g.calculateVarint32(this.id<<3|d.WIRE_TYPES.LDELIM);for(c=e=0;c<a.length;c++)e+=this.calculateValue(a[c]);b+=g.calculateVarint32(e);b+=e}else for(c=0;c<a.length;c++)b+=g.calculateVarint32(this.id<<3|this.type.wireType),b+=this.calculateValue(a[c])}else b+=g.calculateVarint32(this.id<<3|this.type.wireType),b+=this.calculateValue(a)}catch(k){throw Error("Illegal value for "+this.toString(!0)+": "+a+" ("+k+")");}return b};
k.prototype.calculateValue=function(a){if(null===a)return 0;switch(this.type){case d.TYPES.int32:return 0>a?g.calculateVarint64(a):g.calculateVarint32(a);case d.TYPES.uint32:return g.calculateVarint32(a);case d.TYPES.sint32:return g.calculateVarint32(g.zigZagEncode32(a));case d.TYPES.fixed32:case d.TYPES.sfixed32:case d.TYPES["float"]:return 4;case d.TYPES.int64:case d.TYPES.uint64:return g.calculateVarint64(a);case d.TYPES.sint64:return g.calculateVarint64(g.zigZagEncode64(a));case d.TYPES.fixed64:case d.TYPES.sfixed64:return 8;
...
{value:a.buildOpt()}),Object.defineProperty(c.prototype[a.name],"$options",{value:c[a.name].$options}))})(d[e]);return c}(d,this)};m.Service=q;var n=function(a,c,d){b.call(this,a,c);this.className="Service.Method";this.options=d||{}};n.prototype=Object.create(b.prototype);n.prototype.buildOpt=e.prototype.buildOpt;m.Service.Method=n;q=function(a,b,c,d,e){n.call(this,a,b,e);this.className="Service.RPCMethod";this.requestName=c;this.responseName=d;this.resolvedResponseType=this.resolvedRequestType=null};
q.prototype=Object.create(n.prototype);m.Service.RPCMethod=q;return m}(f);f.Builder=function(d,f,g){var m=function(){this.ptr=this.ns=new g.Namespace(null,"");this.resolved=!1;this.result=null;this.files={};this.importRoot=null};m.prototype.reset=function(){this.ptr=this.ns};m.prototype.define=function(b,d){if("string"!==typeof b||!f.TYPEREF.test(b))throw Error("Illegal package: "+b);var c=b.split("."),k;for(k=0;k<c.length;k++)if(!f.NAME.test(c[k]))throw Error("Illegal package: "+c[k]);for(k=0;k<
c.length;k++)this.ptr.hasChild(c[k])||this.ptr.addChild(new g.Namespace(this.ptr,c[k],d)),this.ptr=this.ptr.getChild(c[k]);return this};m.isValidMessage=function(b){if("string"!==typeof b.name||!f.NAME.test(b.name)||"undefined"!==typeof b.values||"undefined"!==typeof b.rpc)return!1;var e;if("undefined"!==typeof b.fields){if(!d.Util.isArray(b.fields))return!1;var c=[],k;for(e=0;e<b.fields.length;e++){if(!m.isValidMessageField(b.fields[e]))return!1;k=parseInt(b.fields[e].id,10);if(0<=c.indexOf(k))return!1;
c.push(k)}}if("undefined"!==typeof b.enums){if(!d.Util.isArray(b.enums))return!1;for(e=0;e<b.enums.length;e++)if(!m.isValidEnum(b.enums[e]))return!1}if("undefined"!==typeof b.messages){if(!d.Util.isArray(b.messages))return!1;for(e=0;e<b.messages.length;e++)if(!m.isValidMessage(b.messages[e])&&!m.isValidExtend(b.messages[e]))return!1}return"undefined"===typeof b.extensions||d.Util.isArray(b.extensions)&&2===b.extensions.length&&"number"===typeof b.extensions[0]&&"number"===typeof b.extensions[1]?!0:
!1};m.isValidMessageField=function(b){if("string"!==typeof b.rule||"string"!==typeof b.name||"string"!==typeof b.type||"undefined"===typeof b.id||!(f.RULE.test(b.rule)&&f.NAME.test(b.name)&&f.TYPEREF.test(b.type)&&f.ID.test(""+b.id)))return!1;if("undefined"!==typeof b.options){if("object"!==typeof b.options)return!1;for(var d=Object.keys(b.options),c=0,k;c<d.length;c++)if("string"!==typeof(k=d[c])||"string"!==typeof b.options[k]&&"number"!==typeof b.options[k]&&"boolean"!==typeof b.options[k])return!1}return!0};
m.isValidEnum=function(b){if("string"!==typeof b.name||!f.NAME.test(b.name)||"undefined"===typeof b.values||!d.Util.isArray(b.values)||0==b.values.length)return!1;for(var e=0;e<b.values.length;e++)if("object"!=typeof b.values[e]||"string"!==typeof b.values[e].name||"undefined"===typeof b.values[e].id||!f.NAME.test(b.values[e].name)||!f.NEGID.test(""+b.values[e].id))return!1;return!0};m.prototype.create=function(b){if(!b)return this;d.Util.isArray(b)||(b=[b]);if(0==b.length)return this;var e=[],c,
k,f,l,n;for(e.push(b);0<e.length;){b=e.pop();if(d.Util.isArray(b))for(;0<b.length;)if(c=b.shift(),m.isValidMessage(c)){k=new g.Message(this.ptr,c.name,c.options,c.isGroup);if(c.fields&&0<c.fields.length)for(l=0;l<c.fields.length;l++){if(k.hasChild(c.fields[l].id))throw Error("Duplicate field id in message "+k.name+": "+c.fields[l].id);if(c.fields[l].options)for(f=Object.keys(c.fields[l].options),n=0;n<f.length;n++){if("string"!==typeof f[n])throw Error("Illegal field option name in message "+k.name+
"#"+c.fields[l].name+": "+f[n]);if("string"!==typeof c.fields[l].options[f[n]]&&"number"!==typeof c.fields[l].options[f[n]]&&"boolean"!==typeof c.fields[l].options[f[n]])throw Error("Illegal field option value in message "+k.name+"#"+c.fields[l].name+"#"+f[n]+": "+c.fields[l].options[f[n]]);}k.addChild(new g.Message.Field(k,c.fields[l].rule,c.fields[l].type,c.fields[l].name,c.fields[l].id,c.fields[l].options))}f=[];if("undefined"!==typeof c.enums&&0<c.enums.length)for(l=0;l<c.enums.length;l++)f.push(c.enums[l]);
if(c.messages&&0<c.messages.length)for(l=0;l<c.messages.length;l++)f.push(c.messages[l]);c.extensions&&(k.extensions=c.extensions,k.extensions[0]<d.ID_MIN&&(k.extensions[0]=d.ID_MIN),k.extensions[1]>d.ID_MAX&&(k.extensions[1]=d.ID_MAX));this.ptr.addChild(k);0<f.length&&(e.push(b),b=f,this.ptr=k)}else if(m.isValidEnum(c)){k=new g.Enum(this.ptr,c.name,c.options);for(l=0;l<c.values.length;l++)k.addChild(new g.Enum.Value(k,c.values[l].name,c.values[l].id));this.ptr.addChild(k)}else if(m.isValidService(c)){k=
new g.Service(this.ptr,c.name,c.options);for(l in c.rpc)c.rpc.hasOwnProperty(l)&&k.addChild(new g.Service.RPCMethod(k,l,c.rpc[l].request,c.rpc[l].response,c.rpc[l].options));this.ptr.addChild(k)}else if(m.isValidExtend(c))if(k=this.ptr.resolve(c.ref))for(l=0;l<c.fields.length;l++){if(k.hasChild(c.fields[l].id))throw Error("Duplicate extended field id in message "+k.name+": "+c.fields[l].id);if(c.fields[l].id<k.extensions[0]||c.fields[l].id>k.extensions[1])throw Error("Illegal extended field id in message "+
k.name+": "+c.fields[l].id+" ("+k.extensions.join(" to ")+" expected)");k.addChild(new g.Message.Field(k,c.fields[l].rule,c.fields[l].type,c.fields[l].name,c.fields[l].id,c.fields[l].options))}else{if(!/\.?google\.protobuf\./.test(c.ref))throw Error("Extended message "+c.ref+" is not defined");}else throw Error("Not a valid definition: "+JSON.stringify(c));else throw Error("Not a valid namespace: "+JSON.stringify(b));this.ptr=this.ptr.parent}this.resolved=!1;this.result=null;return this};m.prototype["import"]=
function(b,e){if("string"===typeof e){d.Util.IS_NODE&&(e=require("path").resolve(e));if(!0===this.files[e])return this.reset(),this;this.files[e]=!0}if(b.imports&&0<b.imports.length){var c,f="/",m=!1;if("object"===typeof e){if(this.importRoot=e.root,m=!0,c=this.importRoot,e=e.file,0<=c.indexOf("\\")||0<=e.indexOf("\\"))f="\\"}else"string"===typeof e?this.importRoot?c=this.importRoot:0<=e.indexOf("/")?(c=e.replace(/\/[^\/]*$/,""),""===c&&(c="/")):0<=e.indexOf("\\")?(c=e.replace(/\\[^\\]*$/,""),f="\\"):
c=".":c=null;for(var l=0;l<b.imports.length;l++)if("string"===typeof b.imports[l]){if(!c)throw Error("Cannot determine import root: File name is unknown");var g=b.imports[l];if(!/^google\/protobuf\//.test(g)&&(g=c+f+g,!0!==this.files[g])){/\.proto$/i.test(g)&&!d.DotProto&&(g=g.replace(/\.proto$/,".json"));var a=d.Util.fetch(g);if(null===a)throw Error("Failed to import '"+g+"' in '"+e+"': File not found");if(/\.json$/i.test(g))this["import"](JSON.parse(a+""),g);else this["import"]((new d.DotProto.Parser(a+
"")).parse(),g)}}else if(e)if(/\.(\w+)$/.test(e))this["import"](b.imports[l],e.replace(/^(.+)\.(\w+)$/,function(a,b,c){return b+"_import"+l+"."+c}));else this["import"](b.imports[l],e+"_import"+l);else this["import"](b.imports[l]);m&&(this.importRoot=null)}b.messages&&(b["package"]&&this.define(b["package"],b.options),this.create(b.messages),this.reset());b.enums&&(b["package"]&&this.define(b["package"],b.options),this.create(b.enums),this.reset());b.services&&(b["package"]&&this.define(b["package"],
b.options),this.create(b.services),this.reset());b["extends"]&&(b["package"]&&this.define(b["package"],b.options),this.create(b["extends"]),this.reset());return this};m.isValidService=function(b){return!("string"!==typeof b.name||!f.NAME.test(b.name)||"object"!==typeof b.rpc)};m.isValidExtend=function(b){if("string"!==typeof b.ref||!f.TYPEREF.test(b.ref))return!1;var e;if("undefined"!==typeof b.fields){if(!d.Util.isArray(b.fields))return!1;var c=[],k;for(e=0;e<b.fields.length;e++){if(!m.isValidMessageField(b.fields[e]))return!1;
k=parseInt(b.id,10);if(0<=c.indexOf(k))return!1;c.push(k)}}return!0};m.prototype.resolveAll=function(){var b;if(null!=this.ptr&&"object"!==typeof this.ptr.type){if(this.ptr instanceof g.Namespace){b=this.ptr.getChildren();for(var e=0;e<b.length;e++)this.ptr=b[e],this.resolveAll()}else if(this.ptr instanceof g.Message.Field)if(f.TYPE.test(this.ptr.type))this.ptr.type=d.TYPES[this.ptr.type];else{if(!f.TYPEREF.test(this.ptr.type))throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);
b=this.ptr.parent.resolve(this.ptr.type,!0);if(!b)throw Error("Unresolvable type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);this.ptr.resolvedType=b;if(b instanceof g.Enum)this.ptr.type=d.TYPES["enum"];else if(b instanceof g.Message)this.ptr.type=b.isGroup?d.TYPES.group:d.TYPES.message;else throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);}else if(!(this.ptr instanceof d.Reflect.Enum.Value))if(this.ptr instanceof d.Reflect.Service.Method)if(this.ptr instanceof
...
m.Message=function(){};m.Service=function(){};return m}(f,f.Lang,f.Reflect);f.newBuilder=function(d,g){var p=new f.Builder;"undefined"!==typeof d&&null!==d&&p.define(d,g);return p};f.loadJson=function(d,g,p){if("string"===typeof g||g&&"string"===typeof g.file&&"string"===typeof g.root)p=g,g=null;g&&"object"===typeof g||(g=f.newBuilder());"string"===typeof d&&(d=JSON.parse(d));g["import"](d,p);g.resolveAll();g.build();return g};f.loadJsonFile=function(d,g,p){g&&"object"===typeof g?(p=g,g=null):g&&
"function"===typeof g||(g=null);if(g)return f.Util.fetch("string"===typeof d?d:d.root+"/"+d.file,function(b){if(null===b)g(Error("Failed to fetch file"));else try{g(null,f.loadJson(JSON.parse(b),p,d))}catch(e){g(e)}});var m=f.Util.fetch("object"===typeof d?d.root+"/"+d.file:d);return null===m?null:f.loadJson(JSON.parse(m),p,d)};return f}"undefined"!==typeof module&&module.exports?module.exports=s(require("bytebuffer")):"function"===typeof define&&define.amd?define(["ByteBuffer"],s):(r.dcodeIO=r.dcodeIO||
{}).ProtoBuf=s(r.dcodeIO.ByteBuffer)})(this);
