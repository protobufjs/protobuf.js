...
*/
(function(h,w){"function"===typeof define&&define.amd?define(["ByteBuffer"],w):"function"===typeof require&&"object"===typeof module&&module&&module.exports?module.exports=w(require("bytebuffer"),!0):(h.dcodeIO=h.dcodeIO||{}).ProtoBuf=w(h.dcodeIO.ByteBuffer)})(this,function(h,w){var c={};c.ByteBuffer=h;c.Long=h.Long||null;c.VERSION="4.1.1";c.WIRE_TYPES={};c.WIRE_TYPES.VARINT=0;c.WIRE_TYPES.BITS64=1;c.WIRE_TYPES.LDELIM=2;c.WIRE_TYPES.STARTGROUP=3;c.WIRE_TYPES.ENDGROUP=4;c.WIRE_TYPES.BITS32=5;c.PACKABLE_WIRE_TYPES=
...
c.TYPES.int64,c.TYPES.sint64,c.TYPES.sfixed64,c.TYPES.uint64,c.TYPES.fixed64,c.TYPES.bool,c.TYPES.string,c.TYPES.bytes];c.ID_MIN=1;c.ID_MAX=536870911;c.convertFieldsToCamelCase=!1;c.populateAccessors=!0;c.populateDefaults=!0;c.Util=function(){var a={};a.IS_NODE=!(!w||"object"!==typeof process||"[object process]"!==process+""||process.browser);a.XHR=function(){for(var a=[function(){return new XMLHttpRequest},function(){return new ActiveXObject("Msxml2.XMLHTTP")},function(){return new ActiveXObject("Msxml3.XMLHTTP")},
...
[]};var x=function(b,a,c,f,g){d.call(this,b,a,c,f,g);this.className="Enum";this.object=null};x.getName=function(b,a){for(var d=Object.keys(b),c=0,f;c<d.length;++c)if(b[f=d[c]]===a)return f;return null};(x.prototype=Object.create(d.prototype)).build=function(b){if(this.object&&!b)return this.object;b=new a.Builder.Enum;for(var d=this.getChildren(x.Value),c=0,f=d.length;c<f;++c)b[d[c].name]=d[c].id;Object.defineProperty&&Object.defineProperty(b,"$options",{value:this.buildOpt(),enumerable:!1});return this.object=
b};p.Enum=x;f=function(b,d,a,c){l.call(this,b,d,a);this.className="Enum.Value";this.id=c};f.prototype=Object.create(l.prototype);p.Enum.Value=f;var v=function(b,d,a,c){l.call(this,b,d,a);this.field=c};v.prototype=Object.create(l.prototype);p.Extension=v;var z=function(b,a,c,f){d.call(this,b,a,c,f);this.className="Service";this.clazz=null};(z.prototype=Object.create(d.prototype)).build=function(b){return this.clazz&&!b?this.clazz:this.clazz=function(b,d){for(var a=function(a){b.Builder.Service.call(this);
