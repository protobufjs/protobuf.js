...
b){var d={},m;for(m in a)a.hasOwnProperty(m)&&(d[m]=null===a[m]||"object"!==typeof a[m]?a[m]:a[m]instanceof n?b?a[m].toBase64():a[m].toBuffer():c(a[m],b));return d}var d=b.getChildren(a.Reflect.Message.Field),m=b.getChildren(a.Reflect.Message.OneOf),e=function(b,c){a.Builder.Message.call(this);for(var e=0,p=m.length;e<p;++e)this[m[e].name]=null;e=0;for(p=d.length;e<p;++e){var f=d[e];this[f.name]=f.repeated?[]:null;f.required&&null!==f.defaultValue&&(this[f.name]=f.defaultValue)}if(0<arguments.length)if(1!==
