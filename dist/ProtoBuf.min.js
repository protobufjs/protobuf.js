...
this.tn.line+": "+f+" ('"+b.END+"' expected)");return a};d.prototype._parseOption=function(f,a){a=this.tn.next();var c=!1;a==b.COPTOPEN&&(c=!0,a=this.tn.next());if(!b.NAME.test(a)&&!/google\.protobuf\./.test(a))throw Error("Illegal option name in message "+f.name+" at line "+this.tn.line+": "+a);var d=a;a=this.tn.next();if(c){if(a!==b.COPTCLOSE)throw Error("Illegal custom option name delimiter in message "+f.name+", option "+d+" at line "+this.tn.line+": "+a+" ('"+b.COPTCLOSE+"' expected)");d="("+
