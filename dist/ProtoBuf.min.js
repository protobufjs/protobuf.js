...
"Namespace";this.children=[];this.options=b||{}};b.prototype=Object.create(c.prototype);b.prototype.getChildren=function(d){d=d||null;if(null==d)return this.children.slice();for(var b=[],c=0,e=this.children.length;c<e;++c)this.children[c]instanceof d&&(d===a.Field&&this.children[c]instanceof a.ExtendedField||b.push(this.children[c]));return b};b.prototype.addChild=function(d){var b;if(b=this.getChild(d.name))if(b instanceof a.Field&&b.name!==b.originalName&&!this.hasChild(b.originalName))b.name=b.originalName;
