...
*/
(function(p){function q(n){if(!n||!n.zigZagEncode32)throw Error("ProtoBuf.js requires ByteBuffer.js >=1.1.0: Get it at https://github.com/dcodeIO/ByteBuffer.js");var h={VERSION:"1.0.1",WIRE_TYPES:{}};h.WIRE_TYPES.VARINT=0;h.WIRE_TYPES.BITS64=1;h.WIRE_TYPES.LDELIM=2;h.WIRE_TYPES.STARTGROUP=3;h.WIRE_TYPES.ENDGROUP=4;h.WIRE_TYPES.BITS32=5;h.TYPES={int32:{name:"int32",wireType:h.WIRE_TYPES.VARINT},uint32:{name:"uint32",wireType:h.WIRE_TYPES.VARINT},sint32:{name:"sint32",wireType:h.WIRE_TYPES.VARINT},
...
!(c instanceof Array)&&!(c instanceof n)&&!(c instanceof ArrayBuffer)&&!(d.Long&&c instanceof d.Long)){a=Object.keys(c);for(b=0;b<a.length;b++)this.set(a[b],c[a[b]])}else for(b=0;b<arguments.length;b++)b<e.length&&this.set(e[b].name,arguments[b])};a.prototype.add=function(a,e){var d=b.getChild(a);if(!d)throw Error(this+"#"+a+" is undefined");if(!(d instanceof c.Message.Field))throw Error(this+"#"+a+" is not a field: "+d.toString(!0));if(!d.repeated)throw Error(this+"#"+a+" is not a repeated field");
null===this[d.name]&&(this[d.name]=[]);this[d.name].push(d.verifyValue(e,!0))};a.prototype.set=function(a,e){var d=b.getChild(a);if(!d)throw Error(this+"#"+a+" is not a field: undefined");if(!(d instanceof c.Message.Field))throw Error(this+"#"+a+" is not a field: "+d.toString(!0));this[d.name]=d.verifyValue(e)};a.prototype.get=function(a){var e=b.getChild(a);if(!e||!(e instanceof c.Message.Field))throw Error(this+"#"+a+" is not a field: undefined");if(!(e instanceof c.Message.Field))throw Error(this+
"#"+a+" is not a field: "+e.toString(!0));return this[e.name]};for(var f=0;f<e.length;f++)(function(c){var e=c.name.replace(/(_[a-zA-Z])/g,function(b){return b.toUpperCase().replace("_","")}),e=e.substring(0,1).toUpperCase()+e.substring(1),d=c.name.replace(/([A-Z])/g,function(b){return"_"+b});b.hasChild("set"+e)||(a.prototype["set"+e]=function(b){this.set(c.name,b)});b.hasChild("set_"+d)||(a.prototype["set_"+d]=function(b){this.set(c.name,b)});b.hasChild("get"+e)||(a.prototype["get"+e]=function(){return this.get(c.name)});
b.hasChild("get_"+d)||(a.prototype["get_"+d]=function(){return this.get(c.name)})})(e[f]);a.prototype.encode=function(c){c=c||new n;var a=c.littleEndian,e=b.encode(this,c.LE()).flip();c.littleEndian=a;return e};a.prototype.toArrayBuffer=function(){return this.encode().toArrayBuffer()};a.prototype.toBuffer=function(){return this.encode().toBuffer()};a.decode=function(c){c=c?c instanceof n?c:n.wrap(c):new n;var a=c.littleEndian,e=b.decode(c.LE());c.littleEndian=a;return e};a.prototype.toString=function(){return b.toString()};
Object.defineProperty&&Object.defineProperty(a,"$options",{value:b.buildOpt(),enumerable:!1,configurable:!1,writable:!1});return a}(l,this),b=this.getChildren(),e=0;e<b.length;e++)if(b[e]instanceof f)c[b[e].name]=b[e].build();else if(b[e]instanceof a)c[b[e].name]=b[e].build();else if(!(b[e]instanceof a.Field))throw Error("Illegal reflect child of "+this.toString(!0)+": "+b[e].toString(!0));return this.built=c};a.prototype.encode=function(c,b){for(var e=this.getChildren(a.Field),d=0;d<e.length;d++)e[d].encode(c.get(e[d].name),
b);return b};a.prototype.decode=function(c,b){b=b||-1;for(var a=c.offset,d=new this.built;c.offset<a+b||-1==b&&0<c.remaining();){var f=c.readVarint32(),m=f&7,f=f>>3,g=this.getChild(f);if(!g)throw Error("Illegal field id in "+this.toString(!0)+"#decode: "+f);g.repeated&&!g.options.packed?d.add(g.name,g.decode(m,c)):d.set(g.name,g.decode(m,c))}a=this.getChildren(l.Field);for(m=0;m<a.length;m++)if(a[m].required&&null===d[a[m].name])throw a=Error("Missing field "+a[m].toString(!0)+" in "+this.toString(!0)+
"#decode"),a.msg=d,a;return d};l.Message=a;var m=function(c,b,a,d,f,m){g.call(this,c,d);this.required="required"==b;this.repeated="repeated"==b;this.type=a;this.id=f;this.options=m||{}};m.prototype=Object.create(g.prototype);m.prototype.verifyValue=function(c,b){b=b||!1;if(null===c){if(this.required)throw Error("Illegal value for "+this.toString(!0)+": "+c+" (required)");return null}var a;if(this.repeated&&!b){c instanceof Array||(c=[c]);var m=[];for(a=0;a<c.length;a++)m.push(this.verifyValue(c[a],
!0));return m}if(!this.repeated&&c instanceof Array)throw Error("Illegal value for "+this.toString(!0)+": "+c+" (no array expected)");if(this.type==d.TYPES.int32||this.type==d.TYPES.sint32||this.type==d.TYPES.sfixed32)return parseInt(c,10)|0;if(this.type==d.TYPES.uint32||this.type==d.TYPES.fixed32)return parseInt(c,10)>>>0;if(d.Long){if(this.type==d.TYPES.int64||this.type==d.TYPES.sint64||this.type==d.TYPES.sfixed64)return!("object"==typeof c&&c instanceof d.Long)?d.Long.fromNumber(c,!1):c.unsigned?
c.toSigned():c;if(this.type==d.TYPES.uint64||this.type==d.TYPES.fixed64)return!("object"==typeof c&&c instanceof d.Long)?d.Long.fromNumber(c,!0):c.unsigned?c:c.toUnsigned()}if(this.type==d.TYPES.bool)return!!c;if(this.type==d.TYPES["float"]||this.type==d.TYPES["double"])return parseFloat(c);if(this.type==d.TYPES.string)return""+c;if(this.type==d.TYPES.bytes)return"object"==typeof c&&c instanceof n?c:n.wrap(c);if(this.type==d.TYPES["enum"]){m=this.resolvedType.getChildren(f.Value);for(a=0;a<m.length;a++)if(m[a].name==
c||m[a].id==c)return m[a].id;throw Error("Illegal value for "+this.toString(!0)+": "+c+" (not a valid enum value)");}if(this.type==d.TYPES.message){if("object"!=typeof c)throw Error("Illegal value for "+this.toString(!0)+": "+c+" (object expected)");return c instanceof this.resolvedType.built?c:new this.resolvedType.built(c)}throw Error("[INTERNAL ERROR] Illegal value for "+this.toString(!0)+": "+c+" (undefined type "+this.type+")");};m.prototype.encode=function(c,b){c=this.verifyValue(c);if(null==
this.type||"object"!=typeof this.type)throw Error("[INTERNAL ERROR] Unresolved type in "+this.toString(!0)+": "+this.type);if(null===c||this.repeated&&0==c.length)return b;try{if(this.repeated){var a;if(this.options.packed){b.writeVarint32(this.id<<3|d.WIRE_TYPES.LDELIM);b.ensureCapacity(b.offset+=1);var f=b.offset;for(a=0;a<c.length;a++)this.encodeValue(c[a],b);var m=b.offset-f,g=n.calculateVarint32(m);if(1<g){var l=b.slice(f,b.offset),f=f+(g-1);b.offset=f;b.append(l)}b.writeVarint32(m,f-g)}else for(a=
0;a<c.length;a++)b.writeVarint32(this.id<<3|this.type.wireType),this.encodeValue(c[a],b)}else b.writeVarint32(this.id<<3|this.type.wireType),this.encodeValue(c,b)}catch(k){throw b.littleEndian=le,Error("Illegal value for "+this.toString(!0)+": "+c+" ("+k+")");}return b};m.prototype.encodeValue=function(c,b){if(null!==c){if(this.type==d.TYPES.int32||this.type==d.TYPES.uint32)b.writeVarint32(c);else if(this.type==d.TYPES.sint32)b.writeZigZagVarint32(c);else if(this.type==d.TYPES.fixed32)b.writeUint32(c);
else if(this.type==d.TYPES.sfixed32)b.writeInt32(c);else if(this.type==d.TYPES.int64||this.type==d.TYPES.uint64)b.writeVarint64(c);else if(this.type==d.TYPES.sint64)b.writeZigZagVarint64(c);else if(this.type==d.TYPES.fixed64)b.writeUint64(c);else if(this.type==d.TYPES.sfixed64)b.writeInt64(c);else if(this.type==d.TYPES.bool)b.writeVarint32(c?1:0);else if(this.type==d.TYPES["enum"])b.writeVarint32(c);else if(this.type==d.TYPES["float"])b.writeFloat32(c);else if(this.type==d.TYPES["double"])b.writeFloat64(c);
else if(this.type==d.TYPES.string)b.writeVString(c);else if(this.type==d.TYPES.bytes)c.offset>c.length&&(b=b.clone().flip()),b.writeVarint32(c.remaining()),b.append(c);else if(this.type==d.TYPES.message){var a=(new n).LE();this.resolvedType.encode(c,a);b.writeVarint32(a.offset);b.append(a.flip())}else throw Error("[INTERNAL ERROR] Illegal value to encode in "+this.toString(!0)+": "+c+" (unknown type)");return b}};m.prototype.decode=function(c,b,a){if(c!=this.type.wireType&&(a||c!=d.WIRE_TYPES.LDELIM||
!this.repeated))throw Error("Illegal wire type for field "+this.toString(!0)+": "+c+" ("+this.type.wireType+" expected)");if(c==d.WIRE_TYPES.LDELIM&&(this.repeated&&this.options.packed)&&!a){c=b.readVarint32();c=b.offset+c;for(a=[];b.offset<c;)a.push(this.decode(this.type.wireType,b,!0));return a}if(this.type==d.TYPES.int32)return b.readVarint32()|0;if(this.type==d.TYPES.uint32)return b.readVarint32()>>>0;if(this.type==d.TYPES.sint32)return b.readZigZagVarint32()|0;if(this.type==d.TYPES.fixed32)return b.readUint32()>>>
0;if(this.type==d.TYPES.sfixed32)return b.readInt32()|0;if(this.type==d.TYPES.int64)return b.readVarint64();if(this.type==d.TYPES.uint64)return b.readVarint64().toUnsigned();if(this.type==d.TYPES.sint64)return b.readZigZagVarint64();if(this.type==d.TYPES.fixed64)return b.readUint64();if(this.type==d.TYPES.sfixed64)return b.readInt64();if(this.type==d.TYPES.bool)return!!b.readVarint32();if(this.type==d.TYPES["enum"])return b.readVarint32();if(this.type==d.TYPES["float"])return b.readFloat();if(this.type==
d.TYPES["double"])return b.readDouble();if(this.type==d.TYPES.string)return b.readVString();if(this.type==d.TYPES.bytes)return c=b.readVarint32(),a=b.clone(),a.length=a.offset+c,b.offset+=c,a;if(this.type==d.TYPES.message)return c=b.readVarint32(),this.resolvedType.decode(b,c);throw Error("[INTERNAL ERROR] Illegal wire type for "+this.toString(!0)+": "+c);};l.Message.Field=m;var f=function(a,b,e){k.call(this,a,b,e);this.built=null};f.prototype=Object.create(k.prototype);f.prototype.build=function(){for(var a=
...
typeof a.name||!l.NAME.test(a.name)||"undefined"==typeof a.values||!(a.values instanceof Array)||0==a.values.length)return!1;for(var d=0;d<a.values.length;d++)if("object"!=typeof a.values[d]||"string"!=typeof a.values[d].name||"undefined"==typeof a.values[d].id||!l.NAME.test(a.values[d].name)||!l.NEGID.test(""+a.values[d].id))return!1;return!0};k.prototype.create=function(a){if(a&&(a instanceof Array||(a=[a]),0!=a.length)){var d=[],f,c,b,e,h;for(d.push(a);0<d.length;){a=d.pop();if(a instanceof Array)for(;0<
a.length;)if(f=a.shift(),k.isValidMessage(f)){c=new g.Message(this.ptr,f.name,f.options);if(f.fields&&0<f.fields.length)for(e=0;e<f.fields.length;e++){if(!k.isValidMessageField(f.fields[e]))throw Error("Not a valid message field definition in message "+c.name+": "+JSON.stringify(f.fields[e]));if(c.hasChild(f.fields[e].id))throw Error("Duplicate field id in message "+c.name+": "+f.fields[e].id);if(f.fields[e].options){b=Object.keys(f.fields[e].options);for(h=0;h<b.length;h++){if(!l.NAME.test(b[h]))throw Error("Illegal field option name in message "+
c.name+"#"+f.fields[e].name+": "+b[h]);if("string"!=typeof f.fields[e].options[b[h]]&&"number"!=typeof f.fields[e].options[b[h]])throw Error("Illegal field option value in message "+c.name+"#"+f.fields[e].name+"#"+b[h]+": "+f.fields[e].options[b[h]]);}}c.addChild(new g.Message.Field(c,f.fields[e].rule,f.fields[e].type,f.fields[e].name,f.fields[e].id,f.fields[e].options))}b=[];if("undefined"!=typeof f.enums&&0<f.enums.length)for(e=0;e<f.enums.length;e++)b.push(f.enums[e]);if(f.messages&&0<f.messages.length)for(e=
0;e<f.messages.length;e++)b.push(f.messages[e]);this.ptr.addChild(c);0<b.length&&(d.push(a),a=b,this.ptr=c)}else if(k.isValidEnum(f)){c=new g.Enum(this.ptr,f.name,f.options);for(e=0;e<f.values.length;e++)c.addChild(new g.Enum.Value(c,f.values[e].name,f.values[e].id));this.ptr.addChild(c)}else throw Error("Not a valid message or enum definition: "+JSON.stringify(f));else throw Error("Not a valid namespace definition: "+JSON.stringify(a));this.ptr=this.ptr.parent}this.resolved=!1;this.result=null;return this}};
k.isValidImport=function(a){return!/google\/protobuf\//.test(a)};k.prototype["import"]=function(a,g){a["package"]&&this.define(a["package"],a.options);a.messages&&this.create(a.messages);this.reset();a["package"]&&this.define(a["package"],a.options);a.enums&&this.create(a.enums);this.reset();if(a.imports&&0<a.imports.length){if(!g)throw Error("Cannot determine import root: File name is unknown");for(var f=g.replace(/[\/\\][^\/\\]*$/,""),c=0;c<a.imports.length;c++){var b=f+"/"+a.imports[c];if(/\.json$/i.test(b)){var e=
d.Util.fetch(b);if(null===e)throw Error("Failed to import '"+b+"' in '"+g+"': File not found");this["import"](JSON.parse(e),b)}else throw Error("This build of ProtoBuf.js does not include DotProto support. See: https://github.com/dcodeIO/ProtoBuf.js");}}return this};k.prototype.resolveAll=function(){if(!(null==this.ptr||"object"==typeof this.ptr.type)){if(this.ptr instanceof g.Namespace)for(var a=this.ptr.getChildren(),h=0;h<a.length;h++)this.ptr=a[h],this.resolveAll();else if(this.ptr instanceof
g.Message.Field)if(l.TYPE.test(this.ptr.type))this.ptr.type=d.TYPES[this.ptr.type];else{if(!l.TYPEREF.test(this.ptr.type))throw Error("Illegal type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);a=this.ptr.parent.resolve(this.ptr.type);if(!a)throw Error("Unresolvable type reference in "+this.ptr.toString(!0)+": "+this.ptr.type);this.ptr.resolvedType=a;if(a instanceof g.Enum)this.ptr.type=d.TYPES["enum"];else if(a instanceof g.Message)this.ptr.type=d.TYPES.message;else throw Error("Illegal type reference in "+
this.ptr.toString(!0)+": "+this.ptr.type);}else if(!(this.ptr instanceof d.Reflect.Enum.Value))throw Error("Illegal object type in namespace: "+typeof this.ptr+":"+this.ptr);this.reset()}};k.prototype.build=function(a){this.reset();this.resolved||(this.resolveAll(),this.resolved=!0,this.result=null);null==this.result&&(this.result=this.ns.build());if(a){a=a.split(".");for(var d=this.result,f=0;f<a.length;f++)if(d[a[f]])d=d[a[f]];else{d=null;break}return d}return this.result};k.prototype.toString=
function(){return"Builder"};return k}(h,h.Lang,h.Reflect);h.protoFromString=function(d,h,g){throw Error("This build of ProtoBuf.js does not include DotProto support. See: https://github.com/dcodeIO/ProtoBuf.js");};h.protoFromFile=function(d,l,g){if(l&&"object"==typeof l)g=l,l=null;else if(!l||"function"!=typeof l)l=null;if(l)h.Util.fetch(d,function(a){l(h.protoFromString(a,g,d))});else{var k=h.Util.fetch(d);return null!==k?h.protoFromString(k,g,d):null}};h.newBuilder=function(d,l){var g=new h.Builder;
"undefined"!=typeof d&&g.define(d,l);return g};return h}"undefined"!=typeof module&&module.exports?module.exports=q(require("bytebuffer")):"undefined"!=typeof define&&define.amd?define("ProtoBuf",["ByteBuffer"],q):(p.dcodeIO||(p.dcodeIO={}),p.dcodeIO.ProtoBuf=q(p.dcodeIO.ByteBuffer))})(this);
